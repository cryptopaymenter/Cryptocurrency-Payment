    ...
    public class HttpProcessor
    {
        ...
        public void HandleClient(TcpClient tcpClient)
        {
            try
            {
                ...
                HttpRequest request = GetRequest(inputStream, outputStream, tcpClient);
            ...
            {
                Console.WriteLine("HttpProcessor::HandleClient > " + ex.Message);
            }
        }
        ...
        private HttpRequest GetRequest(Stream inputStream, Stream outputStream, TcpClient client)
        {
            //Read Request Line
            ...
            Dictionary<string, string> getParam = null;
            if (method == "GET")
            {
                ...
                if (temp.Length > 1)
                {
                    ...
                    for (int i = 0; i < Params.Length; i++)
                    {
                        ...
                        if (Name[0] == null || Name[0] == "" || Name[1] == null || Name[1] == "") continue;
                        if (!getParam.ContainsKey(Name[0]))
                            getParam.Add(Name[0], Name[1]);
                    }
                }
            }
            ...
            return new HttpRequest()
            {
                ...
                Content = content,
                GetParam = getParam,
                RemoteIP = IPEndPoint.Parse(client.Client.RemoteEndPoint.ToString()).Address.ToString()
            };
        }
